...
export const MediaBackground = ({setSection}:props) => {
  ...
  return (
    <>
      ...
      <div onClick={() => setSection((e) => e + 1 )} className=" w-full h-full p-4 blue-layout text-primary z-10 absolute flex flex-col justify-center items-center translate-x-50 ">
