...
export const StepFour = ({ setSection}:props) => {
    ...
    return (
        <div className=" relative flex flex-col toten:bg-qrcode h-full tablet:bg-none desktop:bg-none laptop:justify-center items-center bg-bb-blue laptop:border-bb-yellow desktop:border-[40px] toten:bg-cover gap-8 tablet:gap-5 text-center ">
