...
export const StepFour = ({ setSection}:props) => {
    ...
    return (
        <div className=" relative flex flex-col toten:bg-qrcode h-full tablet:bg-none desktop:bg-none desktop:justify-center items-center bg-bb-blue border-bb-yellow border-8 tablet:border-none laptop:border-bb-yellow desktop:border-[40px] toten:bg-cover gap-5 text-center ">
                  ...
                  <div className="  tablet:mt-4 toten:mt-24 desktop:mt-0 desktop:items-center">
                    ...
                    <img className=" w-[320px] tablet:w-[300px] border-[20px] tablet:border-[16px] rounded-xl" src={qrcode} alt="" />
                    <button onClick={() =>setSection(1)} className="btn-ylw z-20">CONCLUIR</button>
                    <img className='w-0 toten:w-0 tablet:w-3/4 absolute bottom-0 right-0' src={woman} alt="" />
